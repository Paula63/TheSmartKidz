...
<body id="page-top">
  ...
  <section class="page-section portfolio" id="portfolio">
    <div class="container">
     <a  href="index.php"><button class="btn"><i class="fa fa-home pull-left " href="#right-panel"></i> Home</button></a>
      <!-- Portfolio Section Heading -->
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Geography</h2>
...
<path id="path67" fill="none" stroke="#A9A9A9" stroke-width="2" d="M385,593v55l36,45 M174,525h144l67,68h86l53,54v46"/>
  ...
  <br>
  <br> 
  <button class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger btn  text-black"  data-toggle="modal" data-target= "#portfolioModal3">Start the Quiz</a></button>
        ...
        <div class="modal-body text-center">
          <div class="container">
			...
			<div id='title'>
   			...
   			<br/>
  			<div id='quiz'></div>
    		<div class='button1' id='next'><a href='#'>Next</a></div>
    		<div class='button1' id='prev'><a href='#'>Prev</a></div>
    		<div class='button1' id='start'> <a href='#'>Start Over</a></div>
