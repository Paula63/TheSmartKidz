...
<html lang="en">
  ...
  <section class="page-section portfolio" id="portfolio">
    <div class="container" >
	  <div class="row justify-content-between"><div class = "col-10"><a href = "index.php"> <img src ="../../img/back.png" width="80" height="80" ></a></div>
  <div class = "col-2"><a href = "../index.php"> <img src ="../../img/home.png" width="80" height="80" ></a></div> </div>
	
	
        
   
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Maths</h2>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
         <a href ="mathspages/learncateg.html">
